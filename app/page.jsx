  ...
  const projects = [
    {
      ...
      title: "e-commerce",
      description:
        "Developed a modern e-commerce website using Next.js and Tailwind CSS, featuring a clean UI/UX with product showcase, wishlist, cart functionality, and responsive design. Deployed on Vercel for fast and secure performance",
      icon: <Download className="w-8 h-8 text-white" />,
      img: "/img/projects/ecommerce.png",
      gradient: "bg-gradient-to-r from-red-600 to-black",
      tags: ["Electron", "React", "Node.js", "yt-dlp", ],
      liveUrl: "https://e-commerce-six-liard-13.vercel.app/",
      githubUrl: "https://github.com/DEEPAK-DEORA-01/E-commerce",
    },
    {
      id: 2,
      title: "Law prep clone",
      description:
        "Developed an EdTech website for Law Prep Tutorial with responsive design, course listings, test series, and demo booking form. Deployed on Vercel for smooth performance.",
      icon: <Video className="w-8 h-8 text-white" />,
      img: "/img/projects/lawprep.png",
      gradient: "bg-gradient-to-r from-gray-700 to-black",
      tags: ["Electron", "JavaScript"],
      liveUrl: "https://law-prep-tutorial-five.vercel.app/",
      githubUrl: "https://github.com/DEEPAK-DEORA-01/Law-Prep-Tutorial",
    },
    {
      id: 3,
      ...
      liveUrl: "https://monsta-clone.vercel.app/",
      githubUrl: "https://github.com/DEEPAK-DEORA-01/monsta-clone",
    },
    {
      id: 4,
      title: "The wake game clone",
      description:
        "Built a gaming website clone for 'The Wake' with interactive UI, sections for classes, realms, gods, game modes, roadmap, and download. Integrated responsive design and social media links, deployed on Vercel",
      icon: <ShoppingCart className="w-8 h-8 text-white" />,
      img: "/img/projects/thewakegame.png",
      gradient: "bg-gradient-to-r from-green-600 to-black",
      tags: ["html", "CSS"],
      liveUrl: "https://the-wake-gaming-clone.vercel.app/",
      githubUrl: "https://github.com/DEEPAK-DEORA-01/The-Wake--gaming-clone",
    },
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div data-aos="fade-up" data-aos-delay="400">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  onClick={() => window.open("https://github.com/DEEPAK-DEORA-01")}
                  variant="outline"
              ...
              <div className="space-y-2 md:space-y-3">
                ...
                <div className="flex space-x-3">
                  <div
                    onClick={() =>
                      window.open(
                        "https://www.linkedin.com/in/deepak-deora/"
                      )
                    }
                  ...
                  <div
                    onClick={() =>
                      window.open(
                        "https://www.instagram.com/deepak_deora_01?igsh=M3ZuOGpmM3hsNHV6"
                      )
                    }
                    className="p-1.5 md:p-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 transition-colors cursor-pointer"
                  >
            ...
            <div className="flex justify-center">
              <div className="relative w-full max-w-md">
                ...
                <img
                  ...
                  className="relative w-[90%] h-[60%] drop-shadow-2xl rounded-2xl md:rounded-3xl"
                />
              </div>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="Hi Deepak, I'd like to discuss a project..."
                    defaultValue={""}
                  />
                </div>
                <div className="pt-2">
                ...
                <div className="mt-8 pt-6 border-t border-white/10">
                  ...
                  <div className="flex space-x-4">
                    {[
                      {
                        icon: Github,
                        href: "https://github.com/DEEPAK-DEORA-01",
                        label: "GitHub",
                      },
                      {
                        icon: Linkedin,
                        href: "https://www.linkedin.com/in/deepak-deora/",
                        label: "LinkedIn",
                      },
                      {
                        icon: Instagram,
                        href: "https://www.instagram.com/deepak_deora_01?igsh=M3ZuOGpmM3hsNHV6",
                        label: "Instagram",
                      },
                    ].map((social, index) => (
                      <a
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 text-xs md:text-sm max-w-2xl mx-auto">
                2025 Deepak deora. All rights reserved. | Privacy Policy |
                Terms of Service
              </p>
            </div>
          </div>
